...
import { CollectionsDetailView } from '@app/components/dynamoplus/Collections/detail/CollectionDetailView';
import { CollectionsDetails } from '@app/components/dynamoplus/Collections/detail/CollectionDetails';
import { useTranslation } from 'react-i18next';
import { getCollection, getDocumentsByCollection, Collection as CollectionData, getIndexesByCollection, Index } from '@app/api/dynamoplus/mocks/system.api';
  ...
  const desktopLayout = (
    <Row gutter={[30,0]}>
      ...
      <Card title={t('dynamoplus.collection.documents')}>
        ...
        {documents && collection && collection.id_key && <CollectionDocuments collectionIdKey={collection.id_key} documents={documents} />}
        </S.ScrollWrapper>
      </Card>
      </Col>
    </Row>
